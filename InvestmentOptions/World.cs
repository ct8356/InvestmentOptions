...
namespace InvestmentOptions
{
    public class World : TreeView
    {
        ...
        public World(InvestmentOption option)
        {
            this.option = option;
            addChildren();
        ...
        public World(ControlPanel controlPanel, InvestmentOption option)
            : this(option)
        {
        ...
        public void handleTreeNode(System.Windows.Forms.TreeNode treeNode, TreeNodeMouseClickEventArgs e)
        {
            TreeNode myTreeNode = treeNode as TreeNode;
            if (myTreeNode is LeafNode)
            {//if it was a LeafNode
                LeafNode leafNode = (LeafNode)myTreeNode;
                System.Windows.Forms.TreeNode nSel = SelectedNode;
